...
public class BPmeter extends Thread
{
   ...
   private static BigInteger  power(BigInteger a, BigInteger b) 
   {
    ...
    public static void main (String args[]) throws IOException
    {
        ...
        System.out.println("\n");
        System.out.println("***************************");
        System.out.println("SYSTOLIC PRESSURE           : "+sys);
        System.out.println("DIASTOLIC PRESSURE          : "+dia);
        System.out.println("***************************");
        try
    {
            Thread.sleep(3000);
        ...
        obj.put("ENC_SYSTOLIC_PRESSURE",s);
        obj.put("ENC_DIASTOLIC_PRESSURE",d);
        obj.put("SYSTOLIC_PRESSURE",sys);
        obj.put("DIASTOLIC_PRESSURE",dia);
